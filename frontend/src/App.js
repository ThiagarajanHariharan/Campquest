      ...
      <div className="drawer">
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <div role="switch" aria-checked={theme === 'dark'} tabIndex={0} aria-label="Toggle Theme" className={`toggle ${theme === 'dark' ? 'on' : ''}`} onClick={onThemeToggle} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onThemeToggle(); } }}>
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <div role="switch" aria-checked={notifications} tabIndex={0} aria-label="Toggle Notifications" className={`toggle ${notifications ? 'on' : ''}`} onClick={onNotifToggle} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onNotifToggle(); } }}>
              <div className="toggle-knob"/>
            </div>
          </div>
        </div>
