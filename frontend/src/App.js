  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          <button aria-label="Menu" className="icon-btn" onClick={() => setShowSettings(true)}>☰</button>
          <div className="header-center">
            <span className="greeting">Greetings, {user.name}! 👋</span>
          </div>
          <div className="header-right">
            <span className="points-badge">⭐ {questPoints}</span>
            <button aria-label="Settings" className="icon-btn" onClick={() => setShowSettings(true)}>⚙️</button>
          </div>
        </div>
      </header>
