    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-card" onClick={e => e.stopPropagation()}>
        ...
        <div className="form-group">
          ...
          <select id="activity-type" value={form.activity_type} onChange={e => setForm({...form, activity_type: e.target.value})}>
        ...
        <div className="form-group">
          ...
          <input id="distance-miles" type="number" step="0.1" min="0.1" placeholder="e.g. 3.5"
      ...
      <div className="drawer">
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <button role="switch" aria-checked={theme === 'dark'} aria-label="Toggle dark mode" className={`toggle ${theme === 'dark' ? 'on' : ''}`} onClick={onThemeToggle}>
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <button role="switch" aria-checked={notifications} aria-label="Toggle notifications" className={`toggle ${notifications ? 'on' : ''}`} onClick={onNotifToggle}>
              <div className="toggle-knob"/>
            </button>
          </div>
        </div>
        ...
        <div style={{ marginTop: 'auto', padding: '16px' }}>
          <button className="btn btn-logout" aria-label="Log out" onClick={onLogout}>🚪 Log Out</button>
        </div>
      </div>
    </>
  );
