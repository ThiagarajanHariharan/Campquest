      ...
      <div className="drawer">
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <div className={`toggle ${theme === 'dark' ? 'on' : ''}`} onClick={onThemeToggle} role="switch" aria-checked={theme === 'dark'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onThemeToggle(); } }} aria-labelledby="theme-label">
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <div className={`toggle ${notifications ? 'on' : ''}`} onClick={onNotifToggle} role="switch" aria-checked={notifications} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onNotifToggle(); } }} aria-labelledby="notif-label">
              <div className="toggle-knob"/>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          <button className="icon-btn" aria-label="Open settings menu" onClick={() => setShowSettings(true)}>☰</button>
