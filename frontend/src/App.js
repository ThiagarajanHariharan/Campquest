    ...
    <>
      ...
      <div className="drawer">
        <div className="drawer-header">
          <h3>⚙️ Settings</h3>
          <button className="icon-btn" onClick={onClose} aria-label="Close settings" title="Close settings">✕</button>
        </div>
    ...
    <div className="app">
      <header className="header" style={{ background: 'linear-gradient(135deg, #10b981, #059669)' }}>
        <div className="header-content">
          ...
          <button className="icon-btn" onClick={onLogout} aria-label="Log out" title="Log out">🚪</button>
        </div>
      </header>
  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          <button className="icon-btn" onClick={() => setShowSettings(true)} aria-label="Open menu" title="Open menu">☰</button>
          <div className="header-center">
            <span className="greeting">Greetings, {user.name}! 👋</span>
          </div>
          <div className="header-right">
            <span className="points-badge">⭐ {questPoints}</span>
            <button className="icon-btn" onClick={() => setShowSettings(true)} aria-label="Open settings" title="Open settings">⚙️</button>
          </div>
        </div>
      </header>
