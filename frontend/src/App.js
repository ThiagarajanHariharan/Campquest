      ...
      <div className="drawer">
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <div className={`toggle ${theme === 'dark' ? 'on' : ''}`} onClick={onThemeToggle} role="switch" aria-checked={theme === 'dark'} tabIndex={0} aria-labelledby="theme-label" onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onThemeToggle(); } }}>
        ...
        <div className="drawer-section">
          ...
          <div className="toggle-row">
            ...
            <div className={`toggle ${notifications ? 'on' : ''}`} onClick={onNotifToggle} role="switch" aria-checked={notifications} tabIndex={0} aria-labelledby="notif-label" onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onNotifToggle(); } }}>
              <div className="toggle-knob"/>
            </div>
          </div>
        </div>
