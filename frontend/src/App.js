    ...
    <>
      ...
      <div className="drawer">
        ...
        <div className="drawer-section">
          ...
          <div className={`toggle ${theme === 'dark' ? 'on' : ''}`} onClick={onThemeToggle} role="switch" aria-checked={theme === 'dark'} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onThemeToggle(); } }} aria-label="Toggle dark mode">
        ...
        <div className="drawer-section">
          ...
          <div className={`toggle ${notifications ? 'on' : ''}`} onClick={onNotifToggle} role="switch" aria-checked={notifications} tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onNotifToggle(); } }} aria-label="Toggle notifications">
              <div className="toggle-knob"/>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          <button className="icon-btn" onClick={() => setShowSettings(true)} aria-label="Open settings menu">☰</button>
