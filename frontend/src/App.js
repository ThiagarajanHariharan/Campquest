    ...
    <>
      ...
      <div className="drawer">
        <div className="drawer-header">
          <h3>⚙️ Settings</h3>
          <button className="icon-btn" aria-label="Close Settings" title="Close Settings" onClick={onClose}>✕</button>
        </div>
    ...
    <div className="app">
      <header className="header" style={{ background: 'linear-gradient(135deg, #10b981, #059669)' }}>
        <div className="header-content">
          ...
          <button className="icon-btn" aria-label="Log out" title="Log out" onClick={onLogout}>🚪</button>
        </div>
      </header>
  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          <button className="icon-btn" aria-label="Open Settings" title="Open Settings" onClick={() => setShowSettings(true)}>☰</button>
          <div className="header-center">
            <span className="greeting">Greetings, {user.name}! 👋</span>
          </div>
          <div className="header-right">
            <span className="points-badge">⭐ {questPoints}</span>
            <button className="icon-btn" aria-label="Open Settings" title="Open Settings" onClick={() => setShowSettings(true)}>⚙️</button>
          </div>
        </div>
      </header>
