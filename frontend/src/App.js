  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-card" onClick={e => e.stopPropagation()}>
        ...
        <div className="form-group">
          <label htmlFor="activity-dist">Distance (miles)</label>
          <input id="activity-dist" type="number" step="0.1" min="0.1" placeholder="e.g. 3.5"
    ...
    <>
      ...
      <div className="drawer">
        ...
        <div className="drawer-section">
          <label htmlFor="calorie-goal" className="drawer-label">🎯 Daily Calorie Goal</label>
          <div className="goal-row">
            <input id="calorie-goal" type="number" className="goal-input" value={calorieGoal}
      ...
      <div className="login-card">
        ...
        <form onSubmit={handleLogin}>
          <div className="form-group">
            ...
            <input id="login-username" placeholder="Enter your username" value={username} onChange={e => { setUsername(e.target.value); setError(''); }}/>
          </div>
          <div className="form-group">
