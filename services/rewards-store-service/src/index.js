...
app.get('/api/rewards/merchandise', async (req, res) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch merchandise' /* sanitized to prevent information leakage */ });
  }
});
...
app.get('/api/rewards/user/:userId/balance', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch balance' /* sanitized to prevent information leakage */ });
  }
});
...
app.get('/api/rewards/user/:userId/transactions', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch transactions' /* sanitized to prevent information leakage */ });
  }
});
...
app.post('/api/rewards/claim', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to claim merchandise' /* sanitized to prevent information leakage */ });
  } finally {
    client.release();
  }
});
...
app.post('/api/rewards/merchandise', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to create merchandise' /* sanitized to prevent information leakage */ });
  }
});
...
app.put('/api/rewards/merchandise/:merchandiseId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to update merchandise' /* sanitized to prevent information leakage */ });
  }
});
