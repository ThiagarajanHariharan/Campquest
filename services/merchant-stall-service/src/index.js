...
app.get('/health', async (req, res) => {
  try {
    ...
    res.status(503).json({ status: 'unhealthy', service: 'merchant-stall', error: 'Internal Server Error' });
  }
});
...
app.post('/api/merchant/canteen/:canteenId/menu', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to create menu item', details: 'Internal Server Error' });
  }
});
...
app.put('/api/merchant/menu/:menuItemId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to update menu item', details: 'Internal Server Error' });
  }
});
...
app.delete('/api/merchant/menu/:menuItemId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to delete menu item', details: 'Internal Server Error' });
  }
});
...
app.get('/api/merchant/canteen/:canteenId/healthy', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch healthy items', details: 'Internal Server Error' });
  }
});
...
app.get('/api/merchant/menu/:menuItemId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch menu item', details: 'Internal Server Error' });
  }
});
