...
app.get('/api/merchant/canteens', async (req, res) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch canteens' /* sanitized to prevent information leakage */ });
  }
});
...
app.get('/api/merchant/canteen/:canteenId/menu', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch menu' /* sanitized to prevent information leakage */ });
  }
});
...
app.post('/api/merchant/canteen/:canteenId/menu', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to create menu item' /* sanitized to prevent information leakage */ });
  }
});
...
app.put('/api/merchant/menu/:menuItemId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to update menu item' /* sanitized to prevent information leakage */ });
  }
});
...
app.delete('/api/merchant/menu/:menuItemId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to delete menu item' /* sanitized to prevent information leakage */ });
  }
});
...
app.get('/api/merchant/canteen/:canteenId/healthy', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch healthy items' /* sanitized to prevent information leakage */ });
  }
});
...
app.get('/api/merchant/menu/:menuItemId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch menu item' /* sanitized to prevent information leakage */ });
  }
});
