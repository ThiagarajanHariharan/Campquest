...
app.get('/api/fitness/user/:userId', async (req, res) => {
  ...
  try {
    ...
    // ⚡ Bolt Optimization: Run independent queries concurrently to reduce latency
    // Expected impact: Removes sequential waiting time, fetching both results simultaneously.
