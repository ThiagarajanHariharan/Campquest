...
app.post('/api/fitness/sync', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to sync fitness activity', details: 'Internal Server Error' /* secure error message */ });
  } finally {
    client.release();
  }
});
...
app.get('/api/fitness/user/:userId', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch user data', details: 'Internal Server Error' /* secure error message */ });
  }
});
...
app.get('/api/fitness/leaderboard', async (req, res) => {
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch leaderboard', details: 'Internal Server Error' /* secure error message */ });
  }
});
...
app.post('/api/fitness/user', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to create user', details: 'Internal Server Error' /* secure error message */ });
  }
});
...
app.get('/api/fitness/activities', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch activities', details: 'Internal Server Error' /* secure error message */ });
  }
});
