...
app.get('/api/fitness/user/:userId', async (req, res) => {
  ...
  try {
    ...
    // ⚡ Bolt Performance Optimization: Parallelize independent database queries
    // Expected impact: Reduces total latency by ~50% for this endpoint by eliminating sequential wait times
