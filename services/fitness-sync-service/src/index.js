...
app.get('/api/fitness/user/:userId', async (req, res) => {
  ...
  try {
    ...
    // ⚡ Bolt: Parallelize independent database queries to reduce overall endpoint latency.
    // Expected impact: Eliminates the sequential wait time between the activities query and stats query.
