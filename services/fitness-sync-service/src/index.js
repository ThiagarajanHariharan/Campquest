...
app.get('/api/fitness/user/:userId', async (req, res) => {
  ...
  try {
    ...
    // ⚡ Bolt: Execute independent queries concurrently with Promise.all
    // We only do this after awaiting the validation query above to avoid unnecessary queries on 404
